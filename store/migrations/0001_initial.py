    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sd', models.BooleanField(default=True, verbose_name='Наличие слота для SD')),
        ...
        migrations.AddField(
            model_name='cart',
            name='products',
            field=models.ManyToManyField(blank=True, null=True, related_name='related_cart', to='store.CartProduct'),
        ),
    ]
